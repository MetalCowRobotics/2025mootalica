...
public class KalmanFilter {
     ...
     * Constructor
     *
     * @param R Process noise - internal state
     * @param Q Measurement noise - sensor
     */
     ...
     *
     * @param measurement The measurement value to be filtered - sensor
     * @param u The controlled input value - internal
